...
export const translations = {
  pl: {
    ...
    privacyBadge: '100% On-Device AI Vision (Prywatność – obraz nie opuszcza laptopa)',
    ...
    cameraPromptDesc: 'Aplikacja analizuje Twoją sylwetkę w 100% lokalnie na Twoim laptopie. Wideo nigdy nie opuszcza urządzenia.',
    ...
    setCompletedDescMaster: 'Mistrzowska technika! Utrzymałeś pełen zakres ruchu i doskonałą stabilizację.',
    setCompletedDescGood: 'Bardzo dobra forma. Większość powtórzeń wykonana w idealnym tempie.',
    setCompletedDescRetry: 'Dobra próba. Zwróć uwagę na głębokość i stabilizację.',
    accuracyScore: 'Celność Formy',
    energyBurned: 'Spalone kcal',
    timeSpent: 'Czas Pracy',
    safePatternBadge: 'Wzorzec bezpieczny: Kąty stawów w rekomendowanym oknie biomechanicznym.',
    ...
    voiceControlTooltip: 'Steruj treningiem bez dotykania urządzenia: powiedz "następne", "reset", "wycisz"',
    voiceCommandsHelpTitle: 'Dostępne Komendy Głosowe',
    voiceCommandsList: [
      { cmd: '„Następne” / „Dalej”', desc: 'Przejdź do kolejnego ćwiczenia' },
      { cmd: '„Poprzednie” / „Wstecz”', desc: 'Wróć do poprzedniego ćwiczenia' },
      ...
      { cmd: '„Symulacja” / „Test”', desc: 'Uruchom automatyczny symulator AI' },
    ],
    recognizedBadge: 'Rozpoznano komendę',
    micPermissionDenied: 'Dostęp do mikrofonu został zablokowany w przeglądarce.',
    // Mobile Features
    ...
    exercises: {
      squats: {
        ...
        description: 'Głębokie przysiady wzmacniające mięśnie czworogłowe, pośladki i stabilizację tułowia.',
        cues: [
          'Stopy rozstawione na szerokość barków',
          'Kolana prowadzone zgodnie z linią stóp',
          'Uda równoległe do podłoża (kąt kolan ≤ 90°)',
        ],
        muscles: ['Czworogłowe ud', 'Pośladkowe', 'Kulszowo-goleniowe', 'Mięśnie głębokie brzucha'],
      },
      jumping_jacks: {
        name: 'Pajacyki (Jumping Jacks)',
        category: 'Kardio',
        difficulty: 'Początkujący',
        description: 'Dynamiczny trening wydolnościowy z koordynacją wymachów rąk i nóg.',
        cues: [
      ...
      high_knees: {
        ...
        description: 'Eksplozywny bieg w miejscu z unoszeniem kolan powyżej linii bioder.',
        cues: [
      ...
      tree_pose: {
        ...
        category: 'Równowaga',
        difficulty: 'Początkujący',
        description: 'Izometryczny trening stabilizacji na jednej nodze, poprawiający równowagę i siłę stawów skokowych.',
        cues: [
      ...
      arm_raises: {
        ...
        difficulty: 'Początkujący',
        description: 'Ćwiczenie mobilizujące i wzmacniające obręcz barkową z zachowaniem symetrii.',
        cues: [
        ...
        muscles: ['Boczne aktony mięśni naramiennych', 'Czworoboczny', 'Stożek rotatorów'],
      },
    },
  ...
  en: {
    ...
    cameraPromptDesc: 'Your posture is computed 100% locally on your device. Video frames are processed in-browser and never uploaded.',
    ...
    setCompletedDescMaster: 'Masterful technique! You maintained full range of motion and solid spinal alignment.',
    setCompletedDescGood: 'Great effort! Most reps hit the biomechanical sweet spot.',
    setCompletedDescRetry: 'Good start! Focus on depth and keeping knees tracking properly.',
    accuracyScore: 'Form Accuracy',
    energyBurned: 'Calories Burned',
    timeSpent: 'Active Duration',
    safePatternBadge: 'Safe Pattern: Joint angles stayed within the recommended orthopedic window.',
    ...
    voiceControlTooltip: 'Hands-free workout control: say "next", "reset", "mute"',
